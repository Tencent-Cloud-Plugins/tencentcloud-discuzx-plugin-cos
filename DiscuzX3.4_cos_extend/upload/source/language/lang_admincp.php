...
',
    ...
    'setting_attach_remote' => 'FTP远程附件',
    'setting_attach_remote_preview' => '连接测试',
    'setting_attach_remote_preview_comment' => '请在"基本设置"中开启对应的远程附件类型，无需保存设置即可测试，并在测试通过后保存',
    ...
    'setting_attach_remote_url_comment' => '支持 HTTP 和 FTP 协议，结尾不要加斜杠“/”；如果使用 FTP 协议，FTP 服务器必需支持 PASV 模式，为了安全起见，使用 FTP 连接的帐号不要设置可写权限和列表权限；如果使用腾讯云远程附件，此处请填写存储桶的访问域名',
    ...
    'setting_attach_remote_-108' => '腾讯云远程附件功能无效，请检查腾讯云远程附件功能的配置参数是否填写正确',
    ...
    'setting_attach_remote_tencentcos' => '腾讯云远程附件',
    'setting_attach_remote_enabled_tencentcos' => '启用腾讯云远程附件',
    'setting_attach_remote_enabled_ftp' => '启用FTP远程附件',
    'setting_attach_remote_ftp_secretid' => 'SecretId',
    'setting_attach_remote_ftp_secretid_comment' => '访问 <a href="https://console.qcloud.com/cam/capi" target="_blank">密钥管理</a>获取SecretId或通过"新建密钥"创建密钥串',
    'setting_attach_remote_ftp_secretkey' => 'SecretKey',
    'setting_attach_remote_ftp_secretkey_comment' => '访问 <a href="https://console.qcloud.com/cam/capi" target="_blank">密钥管理</a>获取SecretKey或通过"新建密钥"创建密钥串',
    'setting_attach_remote_ftp_region' => '所属区域',
    'setting_attach_remote_ftp_region_comment' => '在腾讯云服务器所在地域，如ap-shanghai',
    'setting_attach_remote_ftp_bucket' => '空间名称',
    'setting_attach_remote_ftp_bucket_comment' => 'COS服务中存储桶的名称，如discuzx-cos-xxxxx',
    'setting_attach_remote_ftp_remoteurl' => '访问域名',
    'setting_attach_remote_ftp_remoteurl_comment' => 'COS服务域名，如https://discuzx-cos-xxxxx.cos.ap-shanghai.myqcloud.com',
    'setting_attach_remote_ftp_cospreview' => '接口测试',
    'setting_attach_remote_tencentcos_preview_btn' => '<input type="button" class="btn" onclick="var oldaction = $(\'cpform\').action;var oldoperation = $(\'cpform\').operation.value;$(\'cpform\').operation.value = \'ftptencentcoscheck\';$(\'cpform\').action=\''.ADMINSCRIPT.'?action=checktools&operation=ftptencentcoscheck&frame=no\';this.form.target=\'ftpcheckiframe\';this.form.submit();$(\'cpform\').action=oldaction;$(\'cpform\').operation.value=oldoperation;$(\'cpform\').target=\'\';return false;" value="测试远程附件" style="vertical-align: middle"><iframe name="ftpcheckiframe" style="display: none"></iframe>',
    'setting_attach_remote_type' => '选择远程附件类型',
    'setting_attach_remote_type_comment' => '选择远程附件类型后，还需要到对应的远程附件配置页面中填写相关配置参数',
    'setting_attach_remote_tencentcos_close' => '腾讯云远程附件功能未开启，请在"基本设置"中开启腾讯与远程附件类型',
    'setting_attach_remote_ftp_close' => 'FTP远程附件功能未开启，请在"基本设置"中开启FTP远程附件类型',
